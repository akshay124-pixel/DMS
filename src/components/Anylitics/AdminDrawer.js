  ...
  const calculateStats = useCallback(async () => {
    ...
    try {
      ...
      if (normalizedRole === "Others") {
        ...
        console.log("Entries after Others filter:", filteredEntries.length);
        if (
          ...
          console.log("Fallback entries for Others:", filteredEntries.length);
        }
      }
      ...
      filteredEntries.forEach((entry) => {
        ...
        const creator = filteredUsers.find((user) => user._id === creatorId);
        if (creator) {
